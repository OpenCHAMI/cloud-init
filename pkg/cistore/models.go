// Package cistore defines data models and the store interface for cloud-init-server.
package cistore
...
// GroupData represents a named group with metadata and optional cloud-config file.
...
// ParseFromJSON parses and validates a GroupData from a JSON payload.
...
// OpenCHAMIComponent wraps a base.Component with network info used by cloud-init.
...
// OpenCHAMIInstanceInfo holds node-specific instance data persisted in the store.
...
// ClusterDefaults represents cluster-wide default meta-data values.
...
// CloudConfigFile wraps raw content and metadata for a cloud-config file.
...
// MarshalJSON implements json.Marshaler for CloudConfigFile.
